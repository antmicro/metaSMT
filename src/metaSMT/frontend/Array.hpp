    ...
    namespace Array {
      ...
      struct Array_Grammar
          : proto::and_<proto::not_<proto::equal_to<proto::_, proto::_> >,
                        proto::or_<proto::terminal<tag::array_var_tag>,
      ...
      struct Array_Domain : proto::domain<proto::generator<Array>, Array_Grammar> {};

      template <typename Expr>
      struct Array : proto::extends<Expr, Array<Expr>, Array_Domain> {
        typedef proto::extends<Expr, Array<Expr>, Array_Domain> base_type;

        Array(Expr const &expr = Expr()) : base_type(expr) {}
      };
      ...
      typename proto::result_of::make_expr<tag::select_tag, Array_Domain, E1 const &, E2 const &>::type select(
          E1 const &e1, E2 const &e2) {
        return proto::make_expr<tag::select_tag, Array_Domain>(boost::cref(e1), boost::cref(e2));
      }

      template <typename E1, typename E2, typename E3>
      typename proto::result_of::make_expr<tag::store_tag, Array_Domain, E1 const &, E2 const &, E3 const &>::type
      ...
      inline array new_array(unsigned elem_width = 1, unsigned index_width = 1) {
