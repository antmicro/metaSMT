...
namespace metaSMT {
  namespace logic {
    ...
    struct Binary_Predicate : proto::or_<proto::binary_expr<tag::equal_tag, Predicate_Grammar, Predicate_Grammar>,
    ...
    struct Predicate_Grammar
        : proto::and_<proto::not_<proto::address_of<proto::_> >, proto::not_<proto::equal_to<proto::_, proto::_> >,
                      proto::or_<proto::terminal<tag::true_tag>, proto::terminal<tag::false_tag>, Binary_Predicate,
    ...
    struct Predicate_Domain : proto::domain<proto::generator<Predicate>, Predicate_Grammar> {};

    template <typename Expr>
    struct Predicate : proto::extends<Expr, Predicate<Expr>, Predicate_Domain> {
      typedef proto::extends<Expr, Predicate<Expr>, Predicate_Domain> base_type;

      Predicate(Expr const &expr = Expr()) : base_type(expr) {}
    };
...
#define _BINARY_PREDICATE(NAME_, TAG_)                                                                             \
  ...
  typename proto::result_of::make_expr<TAG_, Predicate_Domain, E1 const &, E2 const &>::type NAME_(E1 const &e1,   \
                                                                                                   E2 const &e2) { \
...
#undef _BINARY_PREDICATE
    ...
    typename proto::result_of::make_expr<tag::ite_tag, Predicate_Domain, E1 const &, E2 const &, E3 const &>::type Ite(
        E1 const &e1, E2 const &e2, E3 const &e3) {
      return proto::make_expr<tag::ite_tag, Predicate_Domain>(boost::cref(e1), boost::cref(e2), boost::cref(e3));
    }

    typedef proto::result_of::make_expr<proto::tag::terminal, Predicate_Domain, tag::var_tag>::type predicate;

    inline predicate new_variable() {
      tag::var_tag tag;
    ...
    typename proto::result_of::make_expr<tag::not_tag, Predicate_Domain, E1 const &>::type Not(E1 const &e1) {
      return proto::make_expr<tag::not_tag, Predicate_Domain>(boost::cref(e1));
    }

    template <typename E1, typename E2, typename E3>
    typename proto::result_of::make_expr<tag::ite_tag, Predicate_Domain, E1 const &, E2 const &, E3 const &>::type
