...
namespace metaSMT {
  ...
  namespace logic {
    ...
    namespace QF_BV {
      ...
      struct QF_BV_Unary_Function : proto::or_<proto::unary_expr<tag::bvnot_tag, QF_BV_Grammar>,
                                               proto::unary_expr<tag::bvneg_tag, QF_BV_Grammar> > {};

      struct QF_BV_Binary_Function : proto::or_<
                                         // logic
                                         proto::or_<proto::binary_expr<tag::bvand_tag, QF_BV_Grammar, QF_BV_Grammar>,
                                         ...
                                         // arithmetic
                                         ,
                                         proto::or_<proto::binary_expr<tag::bvadd_tag, QF_BV_Grammar, QF_BV_Grammar>,
                                         ...
                                         // extend
                                         ,
                                         proto::or_<proto::binary_expr<tag::concat_tag, QF_BV_Grammar, QF_BV_Grammar>,
                                         ...
                                         // shifting
                                         ,
                                         proto::or_<proto::binary_expr<tag::bvshl_tag, QF_BV_Grammar, QF_BV_Grammar>,
      ...
      struct QF_BV_Binary_Predicate
          : proto::or_<
                // comparison
                proto::or_<proto::binary_expr<tag::bvslt_tag, QF_BV_Grammar, QF_BV_Grammar>,
      ...
      struct QF_BV_BitVector_Constant
          : proto::or_<proto::binary_expr<tag::bvuint_tag, proto::terminal<proto::convertible_to<uint64_t> >,
                                          proto::terminal<proto::convertible_to<uint64_t> > >,
                       proto::binary_expr<tag::bvsint_tag, proto::terminal<proto::convertible_to<int64_t> >,
                                          proto::terminal<proto::convertible_to<uint64_t> > >,
                       proto::unary_expr<tag::bvbin_tag, proto::terminal<proto::convertible_to<std::string> > >,
                       proto::unary_expr<tag::bvhex_tag, proto::terminal<proto::convertible_to<std::string> > > > {};

      // real Grammar
      struct QF_BV_Grammar
          : proto::and_<proto::not_<proto::address_of<proto::_> >, proto::not_<proto::equal_to<proto::_, proto::_> >,
                        proto::or_<proto::terminal<tag::bit0_tag>, proto::terminal<tag::bit1_tag>,
                                   proto::terminal<tag::var_tag>, QF_BV_BitVector_Constant, QF_BV_Binary_Function,
                                   QF_BV_Binary_Predicate, QF_BV_Unary_Function> > {};

      template <typename Expr>
      struct QF_BV;

      struct QF_BV_Domain : proto::domain<proto::generator<QF_BV>, QF_BV_Grammar> {};

      template <typename Expr>
      struct QF_BV : proto::extends<Expr, QF_BV<Expr>, QF_BV_Domain> {
        typedef proto::extends<Expr, QF_BV<Expr>, QF_BV_Domain> base_type;

        QF_BV(Expr const &expr = Expr()) : base_type(expr) {}
      };
...
#define _QF_BV_BINARY_FUNCTION(NAME_, TAG_)                                                                    \
  ...
  typename proto::result_of::make_expr<TAG_, QF_BV_Domain, E1 const &, E2 const &>::type NAME_(E1 const &e1,   \
                                                                                               E2 const &e2) { \
...
#define _QF_BV_UNARY_FUNCTION(NAME_, TAG_)                                                         \
  ...
  typename proto::result_of::make_expr<TAG_, QF_BV_Domain, E1 const &>::type NAME_(E1 const &e1) { \
...
#undef _QF_BV_UNARY_FUNCTION
      ...
      // extract operator
      template <typename Expr>
      inline typename proto::result_of::make_expr<tag::extract_tag, QF_BV_Domain, unsigned const &  // from
                                                  ,
      ...
      template <typename Expr>
      inline typename proto::result_of::make_expr<tag::zero_extend_tag, QF_BV_Domain, unsigned const &  // length
                                                  ,
                                                  Expr const &  // Expr
                                                  >::type
      ...
      template <typename Expr>
      inline typename proto::result_of::make_expr<tag::sign_extend_tag, QF_BV_Domain, unsigned const &  // length
                                                  ,
                                                  Expr const &  // Expr
                                                  >::type
      ...
      // constant creation
      typedef proto::result_of::make_expr<tag::bvuint_tag, QF_BV_Domain, uint64_t, unsigned>::type bvuint_result_type;

      inline bvuint_result_type bvuint(uint64_t const &value, unsigned const &width) {
        return proto::make_expr<tag::bvuint_tag, QF_BV_Domain>(value, width);
      }

      typedef proto::result_of::make_expr<tag::bvsint_tag, QF_BV_Domain, int64_t, unsigned>::type bvsint_result_type;

      inline bvsint_result_type bvsint(int64_t const &value, unsigned const &width) {
      ...
      typename boost::enable_if<
          typename boost::mpl::and_<boost::is_integral<Integer>, boost::is_signed<Integer> >::type,
      ...
      template <typename Integer>
      typename boost::enable_if<
          typename boost::mpl::and_<boost::is_integral<Integer>, boost::mpl::not_<boost::is_signed<Integer> > >::type,
          bvuint_result_type>::type
      bvint(Integer value, unsigned const &width) {
        return proto::make_expr<tag::bvuint_tag, QF_BV_Domain>((uint64_t)value, width);
      }

      inline proto::result_of::make_expr<tag::bvbin_tag, QF_BV_Domain, std::string const &>::type bvbin(
          std::string const &value) {
        return proto::make_expr<tag::bvbin_tag, QF_BV_Domain>(boost::cref(value));
      }

      inline proto::result_of::make_expr<tag::bvhex_tag, QF_BV_Domain, std::string const &>::type bvhex(
          std::string const &value) {
      ...
      inline bitvector new_bitvector(unsigned width = 1) {
        tag::var_tag tag;
