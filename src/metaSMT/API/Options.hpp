...
namespace metaSMT {
  ...
  std::string get_option(Context_ &ctx, std::string const &key) {
    BOOST_MPL_ASSERT_MSG((features::supports<Context_, get_option_cmd>::value), context_does_not_support_get_option_api,
                         ());
  ...
  void set_option(Context_ &ctx, std::string const &key, std::string const &value) {
    BOOST_MPL_ASSERT_MSG((features::supports<Context_, set_option_cmd>::value), context_does_not_support_set_option_api,
                         ());
