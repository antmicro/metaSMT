...
namespace metaSMT {
  ...
  typedef mpl::map52<
      ...
      mpl::pair<predtags::implies_tag, mpl::string<'=', '>'> >, mpl::pair<predtags::equal_tag, mpl::string<'='> >,
      mpl::pair<predtags::xor_tag, mpl::string<'x', 'o', 'r'> >

      ,
      mpl::pair<predtags::and_tag, mpl::string<'a', 'n', 'd'> >, mpl::pair<predtags::or_tag, mpl::string<'o', 'r'> >,
      ...
      mpl::pair<bvtags::zero_extend_tag,
                string_concat<mpl::string<'z', 'e', 'r', 'o', '_'>, mpl::string<'e', 'x', 't', 'e', 'n', 'd'> >::type>,
      mpl::pair<bvtags::sign_extend_tag,
                string_concat<mpl::string<'s', 'i', 'g', 'n', '_'>, mpl::string<'e', 'x', 't', 'e', 'n', 'd'> >::type>,
  ...
  inline typename boost::enable_if<typename mpl::has_key<SMT_NameMap, Tag>::type, std::string>::type get_tag_name(
      Tag const &t) {
  ...
  template <typename Tag>
  inline typename boost::disable_if<typename mpl::has_key<SMT_NameMap, Tag>::type, std::string>::type get_tag_name(
      Tag const &t) {
    return "unknown_name";
  }

  typedef mpl::map7<mpl::pair<predtags::nequal_tag, mpl::pair<predtags::not_tag, predtags::equal_tag> >,
